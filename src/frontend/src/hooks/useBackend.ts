  ...
  return useMutation({
    mutationFn: async ({
      ...
      const user = {
        ...
        frozenAadhaar: data.user?.frozenAadhaar ?? true,
        frozenPhone: data.user?.frozenPhone ?? true,
        course: data.user?.course || "",
        stream: data.user?.stream || data.user?.educationSpecialization || "",
        educationSpecialization: data.user?.educationSpecialization || "",
